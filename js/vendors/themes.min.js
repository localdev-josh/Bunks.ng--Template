    ...
    var i = "liquidSubmenu",
        ...
        s = function () {
            ...
            return _createClass(n, [{
                ...
                key: "offHandlers",
                value: function t(n) {
                    $(e).width() <= liquidMobileNavBreakpoint() ? ($(n).off(), $(n).children("a").off()) : this.eventHandlers(n)
                }
            }, {
                key: "positioning",
                value: function e(t) {
        ...
        s = function () {
            ...
            return _createClass(e, [{
                ...
                value: function e() {
                    ...
                    var n = imagesLoaded(this.targetImage);
                    this.setBgImage(), n.on("done", function () {
                        return t.onLoad()
                    })
                }
            }, {
            ...
            return _createClass(t, [{
                ...
                value: function e(t) {
                    var n = this,
                        ...
                        l = i.easing,
                        r = [];
                    r = t || ($.isArray(this.animationTarget) ? this.animationTarget : $.makeArray(this.animationTarget)), r = "backward" == i.direction ? r.reverse() : r;
                    var u = {
                            targets: r,
                            duration: o,
                            easing: l,
        ...
        i.prototype = {
            ...
            onShown: function t(n) {
                var i = $(n.target),
                    ...
                    o = $(e),
                    l = a.offset().top;
                l <= o.scrollTop() - 15 && $("html, body").animate({
                    scrollTop: l - 45
                }, 800), this.initPlugins(s)
            },
            initPlugins: function e(t) {
    ...
    i.prototype = {
        ...
        addColors: function e(i) {
            ...
            return a.prepend(d.documentElement), (void 0 === n ? "undefined" : _typeof(n)) !== (void 0 === l ? "undefined" : _typeof(l)) && null !== l && (l = l.split(":"), n === l[1] && (l[1] = l[0]), r.innerHTML = "#" + this.$element.attr("id") + ":hover .iconbox-icon-container defs stop:first-child{stop-color:" + l[0] + ";}#" + this.$element.attr("id") + ":hover .iconbox-icon-container defs stop:last-child{stop-color:" + l[1] + ";}", a.prepend(r)),
                s.customColorApplied && a.find("path, rect, ellipse, circle, polygon, polyline, line").attr({
                    stroke: "url(#grad" + o + ")",
                    fill: "none"
    ...
    i.prototype = {
        ...
        fullwidthSide: function t() {
            ...
            if (this.options.fullwidthSide) {
                var a = this,
                    s = $(a.element),
                    o = $(this.flickityData.viewport),
                    l = this.flickityData.size.width,
                    r = o.offset(),
                    u = $(e).width(),
                    c = u - (l + r.left),
                    d = this.isRTL ? "marginLeft" : "marginRight",
                    h = this.isRTL ? "paddingLeft" : "paddingRight",
                    f = $('<div class="flickity-viewport-wrap" />');
                o.parent(".flickity-viewport-wrap").length || o.wrap(f), f = o.parent(), f.css((n = {}, _defineProperty(n, d, ""), _defineProperty(n, h, ""), n)), f.css((i = {}, _defineProperty(i, d, c >= 0 ? -1 * (c - 1) : c - 1), _defineProperty(i, h, Math.abs(c - 1)), _defineProperty(i, "overflow", "hidden"), i)), o.css("overflow", "visible"), s.flickity("resize")
            }
        },
...
! function ($, e, t, n) {
    ...
    if ($(window).width() <= liquidMobileNavBreakpoint() || liquidIsMobile()) return !1;
                    ...
                    t.on("mousedown vmousedown", function (e) {
                        ...
                        t.parents().on("mousemove vmousemove", function (e) {
                            a.dragging || (a.dragging = !0, requestAnimationFrame(function () {
                                a._animateDraggedHandle(e, o, s, u, c, l, r, n)
                            }))
...
! function ($, e, t, n) {
    ...
    if ($("body").hasClass("compose-mode") || liquidIsMobile() || liquidWindowWidth() <= liquidMobileNavBreakpoint()) return !1;
    ...
    var i = "liquidLocalScroll",
        ...
        s = function () {
            ...
            return _createClass(n, [{
                ...
                key: "getScrollSpeed",
                value: function e() {
                    var n = t.querySelector("body").getAttribute("data-localscroll-speed");
                    n && (this.options.scrollSpeed = parseInt(n, 10))
                }
            }, {
                key: "getElement",
                value: function e() {
                ...
                key: "eventListeners",
                value: function e(t) {
                    $(t).on("click", this.onClick.bind(this, t)), this.$window.on("scroll", this.onWindowScroll.bind(this, t))
                }
            }, {
                ...
                value: function e(t) {
                    var n = $(this.getTarget(t)),
                        i = this.getDestinationOffsetTop(n),
                        a = this.getOffsetElementsHeight(n),
                        s = this.$element.closest(".navbar-collapse");
                    n.length && (event.preventDefault(), event.stopPropagation(), liquidWindowWidth() <= liquidMobileNavBreakpoint() && s.length && s.collapse("hide"), $("html, body").animate({
                        scrollTop: i - a
                ...
                value: function e(t) {
                    var n = $(t),
                        ...
                        s = $(n.attr("href")).get(0);
                    return this.options.scrollBelowSection ? a.get(0) : s
                }
            }, {
                key: "onWindowScroll",
                value: function e(n) {
                    if (!n.hasAttribute("href")) return !1;
                    if (n.getAttribute("href").indexOf("#") >= 0 && $(n.getAttribute("href")).length) {
                        var i = $(n),
                            a = $(i.attr("href")),
                            s = this.getDestinationOffsetTop(a),
                            o = this.getOffsetElementsHeight(a);
                        (t.documentElement.scrollTop || t.body.scrollTop) >= s - o - 50 ? i.parent().addClass("is-active").siblings().removeClass("is-active") : i.parent().removeClass("is-active")
                    }
                }
            }]), n
        }();
